...
public class ArbolBinarioBusqueda<K extends Comparable<K>, V> implements IArbolBusqueda<K, V> {
    ...
    public ArbolBinarioBusqueda(List<K> claveInOrden, List<V> valoresInOrden,
        ...
        if (esConPreOrden) {
            this.raiz = this.reconstruirConPreOrden(claveInOrden, valoresInOrden, claveNoInOrden, valoresNoInOrden);
        } else {
            this.raiz = this.reconstruirConPostOrden(claveInOrden, valoresInOrden, claveNoInOrden, valoresNoInOrden);
        }
    }

    public NodoBinario<K, V> reconstruirConPreOrden(List<K> claveInOrden, List<V> valoresInOrden,
            List<K> claveNoInOrden, List<V> valoresNoInOrden) {
        return NodoBinario.nodoVacio();
    }

    public NodoBinario<K, V> reconstruirConPostOrden(List<K> claveInOrden, List<V> valoresInOrden,
            List<K> claveNoInOrden, List<V> valoresNoInOrden) {
        return NodoBinario.nodoVacio();
    }
...
//    no vació
    ...
    public boolean ejercicio15(ArbolBinarioBusqueda<K, V> arbolAComparar) {
